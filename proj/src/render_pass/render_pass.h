...
public:
	...
	void setup(class RenderEngine* engine, std::vector<std::shared_ptr<class Texture>> resources);
...
private:
	virtual void setupInternal(class RenderEngine* engine, std::vector<std::shared_ptr<class Texture>> resources) = 0;
